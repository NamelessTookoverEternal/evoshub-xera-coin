...
### XeraMiningDistributor$Data
TL-B: `_ minter:address jettonWalletCode:^cell vesting:address signerPublicKey:uint256 admin:address maxAllocation:coins totalDistributed:coins paused:bool consumed:dict<int, bool> = XeraMiningDistributor`
Signature: `XeraMiningDistributor{minter:address,jettonWalletCode:^cell,vesting:address,signerPublicKey:uint256,admin:address,maxAllocation:coins,totalDistributed:coins,paused:bool,consumed:dict<int, bool>}`
...
* 15577: XeraMiningDistributor: zero amount
* 17068: XeraJettonWallet: not owner
* 23160: XeraMiningDistributor: claim expired
* 26240: XeraJettonWallet: insufficient balance
* 29707: XeraJettonWallet: unauthorized credit
* 31814: XeraMiningDistributor: reference already consumed
* 51332: XeraMiningDistributor: paused
* 54449: XeraMiningDistributor: invalid signature
* 56540: XeraMiningDistributor: not admin
* 61156: XeraMiningDistributor: mining cap exceeded
* 63486: XeraMiningDistributor: insufficient gas attached

## Trait inheritance diagram

```mermaid
graph TD
XeraMiningDistributor
XeraMiningDistributor --> BaseTrait
XeraMiningDistributor --> Deployable
...
graph TD
XeraMiningDistributor
XeraMiningDistributor --> XeraJettonWallet
```