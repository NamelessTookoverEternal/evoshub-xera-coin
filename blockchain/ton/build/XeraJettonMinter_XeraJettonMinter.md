...
### XeraJettonMinter$Data
TL-B: `_ totalSupply:coins mintableSupply:coins admin:address jettonWalletCode:^cell content:^cell = XeraJettonMinter`
Signature: `XeraJettonMinter{totalSupply:coins,mintableSupply:coins,admin:address,jettonWalletCode:^cell,content:^cell}`
...
* 10798: XeraJettonMinter: unauthorized burn notification
* 17068: XeraJettonWallet: not owner
* 26240: XeraJettonWallet: insufficient balance
* 29707: XeraJettonWallet: unauthorized credit
* 50868: XeraJettonMinter: exceeds chain cap
* 60173: XeraJettonMinter: not admin
...
graph TD
XeraJettonMinter
XeraJettonMinter --> BaseTrait
XeraJettonMinter --> Deployable
...
graph TD
XeraJettonMinter
XeraJettonMinter --> XeraJettonWallet
```