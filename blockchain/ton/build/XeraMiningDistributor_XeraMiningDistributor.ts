...
export function dictValueParserXeraMiningDistributor$Data(): DictionaryValue<XeraMiningDistributor$Data> {
 ...
 type XeraMiningDistributor_init_args = {
    $$type: 'XeraMiningDistributor_init_args';
    minter: Address;
    jettonWalletCode: Cell;
    vesting: Address;
...
function initXeraMiningDistributor_init_args(src: XeraMiningDistributor_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.minter);
        b_0.storeRef(src.jettonWalletCode);
        ...
        const b_1 = new Builder();
        b_1.storeAddress(src.admin);
        b_1.storeInt(src.maxAllocation, 257);
        b_0.storeRef(b_1.endCell());
    };
}
...
export const XeraMiningDistributor_errors = {
...
export const XeraMiningDistributor_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const XeraMiningDistributor_types: ABIType[] = [
...
const XeraMiningDistributor_opcodes = {
    "Deploy": 2490013878,
    "DeployOk": 2952335191,
...
const XeraMiningDistributor_getters: ABIGetter[] = [
    {"name":"is_consumed","methodId":115059,"arguments":[{"name":"referenceId","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"bool","optional":false}},
    {"name":"total_distributed","methodId":123148,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"claim_gas_requirement","methodId":88950,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"max_allocation","methodId":71979,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

export const XeraMiningDistributor_getterMapping: { [key: string]: string } = {
    'is_consumed': 'getIsConsumed',
    'total_distributed': 'getTotalDistributed',
    'claim_gas_requirement': 'getClaimGasRequirement',
    'max_allocation': 'getMaxAllocation',
}

const XeraMiningDistributor_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"Claim"}},
    {"receiver":"internal","message":{"kind":"typed","type":"RotateSigner"}},
    {"receiver":"internal","message":{"kind":"typed","type":"SetPaused"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]


export class XeraMiningDistributor implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = XeraMiningDistributor_errors_backward;
    public static readonly opcodes = XeraMiningDistributor_opcodes;
    
    static async init(minter: Address, jettonWalletCode: Cell, vesting: Address, signerPublicKey: bigint, admin: Address, maxAllocation: bigint) {
        return await XeraMiningDistributor_init(minter, jettonWalletCode, vesting, signerPublicKey, admin, maxAllocation);
    }
    
    static async fromInit(minter: Address, jettonWalletCode: Cell, vesting: Address, signerPublicKey: bigint, admin: Address, maxAllocation: bigint) {
        const __gen_init = await XeraMiningDistributor_init(minter, jettonWalletCode, vesting, signerPublicKey, admin, maxAllocation);
        const address = contractAddress(0, __gen_init);
        return new XeraMiningDistributor(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new XeraMiningDistributor(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  XeraMiningDistributor_types,
        getters: XeraMiningDistributor_getters,
        receivers: XeraMiningDistributor_receivers,
        errors: XeraMiningDistributor_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: Claim | RotateSigner | SetPaused | Deploy) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'RotateSigner') {
            body = beginCell().store(storeRotateSigner(message)).endCell();
        }
    ...
    async getIsConsumed(provider: ContractProvider, referenceId: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(referenceId);
        const source = (await provider.get('is_consumed', builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    
    async getTotalDistributed(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('total_distributed', builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getClaimGasRequirement(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('claim_gas_requirement', builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getMaxAllocation(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('max_allocation', builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
